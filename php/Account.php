 ...
 Εισιτηρίων</a>
        ...
        <form action="customize.php">
            <div style="padding: 16px; " >
                <h1 align="center" style=' font-size: 40px;'>Προβολή στοιχείων λογαριασμού</h1>
				 <label><b>Όνομα</b></label> 
				 <text type="text" name="name"> <?php echo $Name ?> </text>
				 <label><b>Επίθετο</b></label>
				 <text type="text" name="surname"> <?php echo $Surname ?> </text>
				 <label><b>Ημερομηνία Γέννησης</b></label> </label>
				 <text type="text" name="date"> <?php echo $Date ?> </text>
				 <label><b>Email</b></label>
				 <text type="email" name="email"> <?php echo $Email ?> </text>
				<div>			
				 <label><b>Κινητό Τηλέφωνο</b></label>
				 <text type="number" name="phone"> <?php echo $Phone ?> </text>
                 <div>
                <a href='index.php'><button type="button" class="cancelbtn">Αρχική Σελίδα</button></a>
                <button type="submit" class="submit" >Επεξεργασία στοιχείων</button>
            </div>
			</div>
		</form>
