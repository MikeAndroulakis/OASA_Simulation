...
<html>
 ...
 Εισιτηρίων</a>
        ...
        <h1 align="center" style=' font-size: 50px;'>Επιτυχής Εγγραφή!</h1>
        <p align="center" style=' font-size: 30px;'>Μπορείτε να συνδεθείτε στον λογαριασμό σας</p>
        <div style="text-align: center;">
        <a href="index.php" style="text-decoration:none;"><button type="button">Αρχική Σελίδα</button></a>
        <a href="login.php" style="text-decoration:none;"><button type="submit">Σύνδεση στον λογαριασμό</button></a>
        </div>
    </body>
